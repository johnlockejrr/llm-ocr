...
class ALTOProcessor:
    ...
    def process_alto_file(self, 
                         xml_path: str, 
                         image_path: str,
                         skip_labels: Optional[List[str]] = None) -> List[ALTOLine]:
        """
    ...
    def _process_text_line(self, 
                          ...
                          page_id: str,
                          block_id: str,
                          skip_labels: List[str]) -> Optional[ALTOLine]:
        """
        ...
        try:
            ...
            points = np.array([[int(n) for n in point.split(',')] 
                             for point in coords.split()], np.int32)
    ...
    def process_directory(self, 
                         ...
                         pattern: str = "*.xml") -> Generator[List[ALTOLine], None, None]:
        """
