...
class OCRPipeline(BasePipeline):
    ...
    def ocr_document(self, lines: List[Line], image_str: str, id: str,
                     mode: ProcessingMode = ProcessingMode.SINGLE_LINE) -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    def _process_single_line(self, model: BaseOCRModel, lines: List[Line], image_str: Optional[str] = None, document_id: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _process_sliding_window(self, model: BaseOCRModel, lines: List[Line],
                               image_str: Optional[str] = None, document_id: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _process_full_page(self, model: BaseOCRModel, lines: List[Line], 
                          image_str: str, document_id: str) -> List[Dict[str, Any]]:
        """
