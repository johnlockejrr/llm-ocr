...
from ..models import OCRResult, Line, ProcessingMode
...
class BasePipeline(ABC):
    ...
    def __init__(self, model: BaseOCRModel, evaluator: OCREvaluator,
    ...
    @abstractmethod
    def ocr_document(self, lines: List[Line], image_path: Optional[Path] = None, 
                         mode: ProcessingMode = ProcessingMode.SINGLE_LINE) -> Dict[str, List[OCRResult]]:
        """
    ...
    def generate_report(self, results: Dict[str, List[OCRResult]],
                        include_details: bool = False) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def _safe_process(self, func, *args, fallback=None, **kwargs):
        """
    ...
    def _match_lines(self, ground_truth_lines: List[Line], 
                    extracted_lines: List[Dict[str, str]]) -> List[Tuple[Line, Optional[Dict[str, str]]]]:
        """
    ...
    def _log_detailed_report(self, model_name: str, report_data: Dict[str, Any]):
