...
class GeminiOCRModel(BaseOCRModel):
    ...
    def process_single_line(self, image_base64: str, id: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            image_part = Part.from_bytes(data=image_base64, mime_type="image/jpeg")
            ...
            if response:
                ...
                return {"line": "", "processing_time": time.time() - start_time, "error": "No text content in response"}
    ...
    def process_sliding_window(self, images_base64: List[str], id: Optional[str] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for img_base64 in images_base64:
                image_part = Part.from_bytes(data=img_base64, mime_type="image/jpeg")
    ...
    def process_full_page(self, page_image_base64: str, document_id: str) -> str:
        ...
        try:
            ...
            image_part = Part.from_bytes(data=page_image_base64, mime_type="image/jpeg")
