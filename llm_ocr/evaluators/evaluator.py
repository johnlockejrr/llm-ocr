...
class OCREvaluator:
    ...
    def evaluate_line(self, ground_truth: str, extracted: str) -> OCRMetrics:
        ...
        for metric_name, metric in self.metrics.items():
            ...
            if not hasattr(self.config, config_attr) or getattr(self.config, config_attr):
                ...
                elif metric_name in ["char_accuracy", "char_accuracy_case_insensitive", "word_accuracy", "old_char_preservation"]:
    ...
    def analyze_errors(self, ground_truth: str, extracted: str) -> Dict[str, Any]:
        ...
        """
        return self.metrics["error_analysis"].evaluate(ground_truth, extracted)
    ...
    def analyze_words(self, ground_truth: str, extracted: str) -> Dict[str, Any]:
        ...
        """
        return self.metrics["word_analysis"].evaluate(ground_truth, extracted)
    ...
    def calculate_similarity(self, ground_truth: str, extracted: str) -> float:
        ...
        """
        return self.metrics["similarity"].evaluate(ground_truth, extracted)
...
class MetricsComparer:
    ...
    @staticmethod
    def compare_metrics(original_metrics: OCRMetrics, corrected_metrics: OCRMetrics) -> Dict[str, float]:
        """
        ...
        """
        return {
            'character_accuracy_delta': round(corrected_metrics.char_accuracy - original_metrics.char_accuracy, 10),
            'word_accuracy_delta': round(corrected_metrics.word_accuracy - original_metrics.word_accuracy, 10),
            'old_char_preservation_delta': round(corrected_metrics.old_char_preservation - original_metrics.old_char_preservation, 10),
            'case_accuracy_delta': round(corrected_metrics.case_accuracy - original_metrics.case_accuracy, 10),
        }
