        ...
        for tag, i1, i2, j1, j2 in matcher.get_opcodes():
            if tag == 'replace':
                analysis["word_substitutions"].append({
                    'ground_truth': gt_words[i1:i2],
                    'extracted': ext_words[j1:j2],
                    'position': i1
                })
            elif tag == 'delete':
                analysis["word_deletions"].append({
                    'words': gt_words[i1:i2],
                    'position': i1
                })
            elif tag == 'insert':
                analysis["word_insertions"].append({
                    'words': ext_words[j1:j2],
                    'position': i1
                })
