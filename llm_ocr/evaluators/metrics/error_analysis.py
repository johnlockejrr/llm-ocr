        ...
        for tag, i1, i2, j1, j2 in matcher.get_opcodes():
            if tag == "replace":
                ...
                analysis["substitutions"].append(
                    {"ground_truth": gt_segment, "extracted": ext_segment, "position": i1}
                )
                ...
                # Character deletion
                analysis["deletions"].append({"text": ground_truth[i1:i2], "position": i1})

            elif tag == "insert":
                # Character insertion
                analysis["insertions"].append({"text": extracted[j1:j2], "position": i1})
