...
class OldCharPreservationMetric(BaseMetric):
    ...
    def __init__(
        self, special_chars: Set[str], frequency_weight: float = 0.6, sequence_weight: float = 0.4
    ):
        """
    ...
    def evaluate(self, ground_truth: str, extracted: str) -> float:
        ...
        combined_score = (
            self.frequency_weight * frequency_score + self.sequence_weight * sequence_score
        )
        ...
        self.detailed_report = {
            ...
            "weights": {"frequency": self.frequency_weight, "sequence": self.sequence_weight},
        }
