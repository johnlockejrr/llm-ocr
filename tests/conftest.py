...
from llm_ocr.models import Line, OCRMetrics, OCRResult, ProcessingMode
...
def mock_llm_model():
    ...
    mock_model.process_single_line.return_value = {"line": "Mocked single line response"}
...
def mock_api_responses():
    ...
    return {
        ...
        "openai": {
            "choices": [
                {"message": {"content": '{"lines": [{"line": "Mocked OpenAI response"}]}'}}
            ],
        ...
        "gemini": {
            "candidates": [
                {
                    "content": {
                        "parts": [{"text": '{"lines": [{"line": "Mocked Gemini response"}]}'}]
                    }
                }
            ]
        },
